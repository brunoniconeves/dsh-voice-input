...
/**
 * No runtime invariant: the settings and slot registrations are effects owned
 * and observed by their respective registries; transcription runs browser-side
 * against the operator's local Whisper endpoint.
 */
